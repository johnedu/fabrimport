...
namespace Project.Tests
{
    ...
    /// Provides methods to easily work with <see cref="ProjectDbContext"/>.
    /// </summary>
    public abstract class AppTestBase : AbpIntegratedTestBase<ProjectTestModule>
    {
